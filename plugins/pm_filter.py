...
async def auto_filter(client, msg, spoll=False):
    ...
    if settings["button"]:
        btn = [
            [
                InlineKeyboardButton(
                    text=f"[{get_size(file.file_size)}] {file.file_name}", url=f'https://{WEBSITE}/st?api={API_KEY}&url=https://t.me/{temp.U_NAME}?start={pre}_{file.file_id}'
                ),
            ]
            for file in files
        ]
        ...
        btn = [
            [
                InlineKeyboardButton(
                    ...
                    url=f'https://{WEBSITE}/st?api={API_KEY}&url=https://t.me/{temp.U_NAME}?start={pre}{file.file_id}',
                ),
                InlineKeyboardButton(
                    text=f"{get_size(file.file_size)}",
